...
const validateBodyPaymentSchema = (req) => {
...
const validateBodyOrderSchema = (req) => {
...
module.exports = { validateBodyPaymentSchema, bodyPaymentSchemaInit, validateBodyOrderSchema, bodyOrderSchemaInit };
